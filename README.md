...
![GitHub](https://img.shields.io/github/license/Chia-Network/gold_rs?logo=Github)
[![Coverage Status](https://coveralls.io/repos/github/Chia-Network/gold_rs/badge.svg?branch=main)](https://coveralls.io/github/Chia-Network/gold_rs?branch=main)
![Build](https://github.com/goldcoin-gl/gold_rs/actions/workflows/build-crate-and-npm.yml/badge.svg)
![Test](https://github.com/goldcoin-gl/gold_rs/actions/workflows/build-test.yml/badge.svg)

![PyPI](https://img.shields.io/pypi/v/gold_rs?logo=pypi)
![PyPI - Format](https://img.shields.io/pypi/format/gold_rs?logo=pypi)
