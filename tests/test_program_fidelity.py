...
def rand_rust_program(rnd: Random) -> gold_rs.Program:
    return gold_rs.Program.from_bytes(b"\xff\x01\xff\x04\x01")
...
def recursive_replace(o: object) -> object:
    if isinstance(o, list):
        ...
        return ret
    elif isinstance(o, gold_rs.Program):
...
def test_run_program() -> None:
    ...
    rust_identity = gold_rs.Program.from_bytes(b"\x01")
...
def test_tree_hash() -> None:
    ...
    for _ in range(10000):
        ...
        rust_prg = gold_rs.Program.from_bytes(bytes(py_prg))
...
def test_uncurry() -> None:
    ...
    for _ in range(10000):
        ...
        rust_prg = gold_rs.Program.from_program(py_prg)
...
def test_round_trip() -> None:
    ...
    for _ in range(10000):
        ...
        rust_prg = gold_rs.Program.from_program(py_prg)
        rust_prg2 = gold_rs.Program.to(obj)
